...
Any recent version of Git should be good.
It's recommended to learn the `git` command-line tool for 
cross-platform independance and a deeper understanding of Git itself.
